...
<body>
 <h1 style="text-align: center; position: absolute; top: 50px;">Add Student Details</h1>
	<div>
<form action="addStudent" method="post">
    ...
    <input type="number" id="number" name="phNumber" required="required" placeholder="PhNumber">

    <label for="age">Age:</label>
    <input type="number" id="age" name="age" required="required" placeholder="AGE">
